# Assignment 04 - React Hooks

## Assignment Brief
> **Create the following custom hooks, and an app that shows off their usage:**
> 1. A “**usePrevious**” hook that takes a piece of state, and returns whatever that state was on the previous render.
> 
> 2. A “**useDebouncedState**” hook that takes an initial value and a debounce time in ms. It should return a [state, setState] array, but the state value should be debounced by the time specified.
> 
